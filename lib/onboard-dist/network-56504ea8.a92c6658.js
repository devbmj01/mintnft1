                        ...
                        return regeneratorRuntime.wrap(function(t) {
                            for (;;)
                                switch (t.prev = t.next) {
                                    case 0:
                                        if (f = n.network, p = n.appNetworkId, w = n.walletSelect, b = n.walletCheck, d = n.exit, h = n.stateSyncStatus, v = n.stateStore, g = n.wallet, null !== f) {
                                            t.next = 5;
                                            break
                                        }
                                        if (!h.network) {
                                        ...
                                        return t.next = 5, new Promise(function(e) {
                                            h.network && h.network.then(e), setTimeout(function() {
                                                null === f && e(void 0)
                                            }, 500)
                                        });
                                    case 5:
                                        if (l || v.network.get() == p || "WalletConnect" === (0, e.f)(null == g ? void 0 : g.provider)) {
                                            t.next = 14;
                                            break
                                        }
                                        return t.prev = 6, l = !0, t.next = 10, null == g ? void 0 : null === (m = g.provider) || void 0 === m ? void 0 : m.request({
                                    ...
                                    case 14:
                                        ...
                                        return t.abrupt("return", {
                                            ...
                                            description: a || "We've detected that you need to switch your wallet's network from <b>".concat((0, e.n)(f), "</b> to <b>").concat((0, e.n)(p), '</b> for this Dapp. <br><br> <i style="font-size: inherit; font-family: inherit;">*Some wallets may not support changing networks. If you can not change networks in your wallet you may consider switching to a different wallet.</i>'),
